...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-zinc-50 font-sans text-zinc-900">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 transform flex-col overflow-hidden border-r border-primary/20 bg-primary text-primary-foreground transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
      ...
      <main className="relative flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="relative flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
          <div className="pointer-events-none absolute top-0 left-0 -z-10 h-64 w-full bg-linear-to-b from-indigo-50/50 to-transparent" />
